...
class Settings(BaseSettings):
    ...
    version: str = "0.1.0"
    environment: str = Field("development", alias="NEXORA_ENV")
    api_host: str = Field("0.0.0.0", alias="NEXORA_API_HOST")
    api_port: int = Field(8000, alias="NEXORA_API_PORT")
    ...
    vercel_token: str | None = Field(None, alias="VERCEL_TOKEN")
